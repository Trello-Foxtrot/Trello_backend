...
urlpatterns = [
    ...
    path('workspace/boards', views.get_boards),
    path('workspace/boards/add', views.add_board),
    path('workspace/boards/delete', views.delete_board),
    path('workspace/boards/rename', views.rename_board),
    path('workspace/boards/lists', views.get_lists),
    path('workspace/boards/lists/add', views.add_list),
    path('workspace/boards/lists/delete', views.delete_list),
